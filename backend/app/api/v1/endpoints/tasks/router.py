...
router.post("/ignore-rules")(create_ignore_rule)
router.get("/ignore-rules")(get_ignore_rules)
router.delete("/ignore-rules/{rule_id}")(delete_ignore_rule)
router.post("/ignore-rules/clear")(clear_ignore_rules)
