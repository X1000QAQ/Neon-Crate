...
**适用范围**：部署流程、Docker 编排、故障排查、运维指南  
**目标受众**：DevOps 工程师、运维人员、部署人员

---

## 文档概述

本指南详细记录 Neon Crate 的 AIO（All-In-One）部署模式，覆盖从源码构建、环境配置、本地启动到 Docker Compose 容器编排的完整部署链路。
